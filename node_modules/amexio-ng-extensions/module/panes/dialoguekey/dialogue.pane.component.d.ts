...
export declare class AmexiodialogueKeyPaneComponent extends LifeCycleBaseComponent implements AfterContentInit, OnChanges, OnInit, OnDestroy {
    private renderer;
    ...
    toggleleft(event: any): void;
    toggleright(event: any): void;
}
