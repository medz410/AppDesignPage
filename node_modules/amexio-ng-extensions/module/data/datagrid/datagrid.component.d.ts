...
export declare class AmexioDatagridComponent extends LifeCycleBaseComponent implements OnInit, OnDestroy, AfterContentInit, AfterViewInit {
    ...
    traverseObj(valObj: any): any[];
    refactorAr(ar: any, stCollection: any): any;
    traverseCompleteRow(row: any): any[];
    setStatus(scollection: any, filteredObj: any, optvalue: any, filtervalue: any): any[];
    chkDataIndex(statusCollection: any, row: any, opt: any, optvalue: any, filtervalue: any, filteredObj: any): any;
    createStatus(opt: any, statusCollection: any, scollection: any, filteredObj: any, optvalue: any, filtervalue: any): any;
    checkValueInColumn(row: any, filteredObj: any): boolean;
    addStatusCollection(statusCollection: any, filteredObj: any, optvalue: any, filtervalue: any): any;
